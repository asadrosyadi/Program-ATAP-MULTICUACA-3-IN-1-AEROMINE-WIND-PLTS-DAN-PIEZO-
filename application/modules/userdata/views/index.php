...
<?php
foreach ($user2 as $u) { //untuk menampilkan variabel data yang diangkut dari controller
?>
	<?php
	$sumber_listrik = $u->sumber_listrik;
	$faktor_daya = $u->faktor_daya;
	$output_dc = $u->output_dc;
	$stopkontak_1 = $u->stopkontak_1;
	$stopkontak_2 = $u->stopkontak_2;
	$lampu = $u->lampu;
	?>
<?php }
...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-left justify-content-between mb-4">
		<div class="ml-auto">
			<form action="<?= site_url('userdata/clearData/') . $HWID ?>" method="post">
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							$query = $CI->db->select('*')->from('datasensor')->where('HWID', $CI->session->userdata('HWID'))->order_by('id', 'DESC')->limit(30)->get()->result(); // limit disesuaikan
							$query2 = $CI->db->select('*')->from('datasensor')->where('HWID', $CI->session->userdata('HWID'))->order_by('id', 'DESC')->limit(60)->get()->result(); // limit disesuaikan
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/arus_masuk/' . $HWID, '<button type="button" class="btn btn-primary text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-success shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/tegangan_masuk/' . $HWID, '<button type="button" class="btn btn-success text-center">Grafik</button>'); ?>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-info shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/daya_masuk/' . $HWID, '<button type="button" class="btn btn-info text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-primary shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/arus_baterai/' . $HWID, '<button type="button" class="btn btn-primary text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-success shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/tegangan_baterai/', '<button type="button" class="btn btn-success text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-info shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/daya_baterai/' . $HWID, '<button type="button" class="btn btn-info text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-danger shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/presentase_baterai/' . $HWID, '<button type="button" class="btn btn-danger text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							$query = $CI->db->select('*')->from('datasensor')->where('HWID', $CI->session->userdata('HWID'))->order_by('id', 'DESC')->limit(30)->get()->result(); // limit disesuaikan
							$query2 = $CI->db->select('*')->from('datasensor')->where('HWID', $CI->session->userdata('HWID'))->order_by('id', 'DESC')->limit(60)->get()->result(); // limit disesuaikan
							$query3 = $CI->db->select('*')->from('datasensor')->where('HWID', $CI->session->userdata('HWID'))->order_by('id', 'DESC')->get()->result(); // limit disesuaikan
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/arus_keluar/' . $HWID, '<button type="button" class="btn btn-primary text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-success shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/tegnagan_keluar/' . $HWID, '<button type="button" class="btn btn-success text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-info shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/daya_keluar/' . $HWID, '<button type="button" class="btn btn-info text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-primary shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/arus_ac/' . $HWID, '<button type="button" class="btn btn-primary text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-success shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/tengangan_ac/' . $HWID, '<button type="button" class="btn btn-success text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-info shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/daya_aktif/' . $HWID, '<button type="button" class="btn btn-info text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-danger shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/daya_reaktif/' . $HWID, '<button type="button" class="btn btn-danger text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-warning shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/daya_semu/' . $HWID, '<button type="button" class="btn btn-warning text-center">Grafik</button>'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-3 col-md-6 mb-5">
			<div class="card border-left-secondary shadow h-90 py-2">
				<div class="card-body">
					...
					<div class="d-sm-flex align-items-left justify-content-between mb-0">
						<div class="ml-auto">
							<?php echo anchor('userdata/faktor_daya/' . $HWID, '<button type="button" class="btn btn-secondary text-center">Grafik</button>'); ?>
						...
						<div class="col mr-2">
							...
							<script>
								...
								function checkAndSetSwitch() {
									const inputValue = "<?= $sumber_listrik; ?>"; // Manually set the value to 1
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<script>
								// Function to check if input value is 1 and set the switch accordingly
								function checkAndSetSwitch() {
									const inputValue = "<?= $faktor_daya; ?>"; // Manually set the value to 1
							...
							<div class="row no-gutters align-items-center">
								<div class="col-auto">
									...
									<script>
										// Function to check if input value is 1 and set the switch accordingly
										function checkAndSetSwitch() {
											const inputValue = "<?= $output_dc; ?>"; // Manually set the value to 1
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<script>
								// Function to check if input value is 1 and set the switch accordingly
								function checkAndSetSwitch() {
									const inputValue = "<?= $stopkontak_1; ?>"; // Manually set the value to 1
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<script>
								// Function to check if input value is 1 and set the switch accordingly
								function checkAndSetSwitch() {
									const inputValue = "<?= $stopkontak_2; ?>"; // Manually set the value to 1
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<script>
								// Function to check if input value is 1 and set the switch accordingly
								function checkAndSetSwitch() {
									const inputValue = "<?= $lampu; ?>"; // Manually set the value to 1
...
<script>
	...
	function sendDataToServer6(switchStatus6) {
		...
		xhr.open('POST', '<?= base_url('userdata/save_switch6/' . $HWID) ?>', true); // Ganti 'update_switch.php' dengan URL ke skrip PHP yang menangani penyimpanan data
	...
	function sendDataToServer5(switchStatus5) {
		var xhr = new XMLHttpRequest();
		xhr.open('POST', '<?= base_url('userdata/save_switch5') ?>', true); // Ganti 'update_switch.php' dengan URL ke skrip PHP yang menangani penyimpanan data
		xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
		xhr.onload = function() {
			if (xhr.status === 200) {
				console.log('Data sent successfully');
	...
	function sendDataToServer4(switchStatus4) {
		var xhr = new XMLHttpRequest();
		xhr.open('POST', '<?= base_url('userdata/save_switch4') ?>', true); // Ganti 'update_switch.php' dengan URL ke skrip PHP yang menangani penyimpanan data
		xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
		xhr.onload = function() {
			if (xhr.status === 200) {
				console.log('Data sent successfully');
	...
	function sendDataToServer3(switchStatus3) {
		var xhr = new XMLHttpRequest();
		xhr.open('POST', '<?= base_url('userdata/save_switch3') ?>', true); // Ganti 'update_switch.php' dengan URL ke skrip PHP yang menangani penyimpanan data
		xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
		xhr.onload = function() {
			if (xhr.status === 200) {
				console.log('Data sent successfully');
	...
	function sendDataToServer2(switchStatus2) {
		var xhr = new XMLHttpRequest();
		xhr.open('POST', '<?= base_url('userdata/save_switch2') ?>', true); // Ganti 'update_switch.php' dengan URL ke skrip PHP yang menangani penyimpanan data
		xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
		xhr.onload = function() {
			if (xhr.status === 200) {
				console.log('Data sent successfully');
	...
	function sendDataToServer1(switchStatus1) {
		var xhr = new XMLHttpRequest();
		xhr.open('POST', '<?= base_url('userdata/save_switch1') ?>', true); // Ganti 'update_switch.php' dengan URL ke skrip PHP yang menangani penyimpanan data
		xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
		xhr.onload = function() {
			if (xhr.status === 200) {
				console.log('Data sent successfully');
